        ...
        <div class="users-modal-content">
            ...
            <div class="users-list">
                ...
                <div class="chat-user">
                    ...
                    <div class="plus-icon" tabindex="0" on:keypress={(e) => e.keyCode === 13 && addAUserToChannel($currentChannel.id, user.id)} on:click={() => addAUserToChannel($currentChannel.id, user.id)}>
        ...
        <div class="users-modal-content">
            ...
            <div class="users-list">
                ...
                <div class="chat-user">
                    <img class="chat-avatar" src="{user.userdata.avatar_url}" alt="channel user avatar">
                    <p>{truncateString(user.userdata.full_name, 20)}</p>
                    <div class="plus-icon" tabindex="0" on:keypress={(e) => e.keyCode === 13 && removeAUserfromChannel($currentChannel.id, user.id)} on:click={() => removeAUserfromChannel($currentChannel.id, user.id)}>
        ...
        <div class="sidebar-modal">
            <div bind:this={sidebar} class="sidebar">
                <div class="add-chat-section">
                    <h3>Chattrum</h3>
                    <div tabindex="0" class="plus-icon" on:keypress={(e) => e.keyCode === 13 && (createNewChannel(), toggleSidebar())} on:click={(() => createNewChannel(), toggleSidebar())}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" viewBox="0 0 1792 1792"><path d="M1600 736v192q0 40-28 68t-68 28h-416v416q0 40-28 68t-68 28h-192q-40 0-68-28t-28-68v-416h-416q-40 0-68-28t-28-68v-192q0-40 28-68t68-28h416v-416q0-40 28-68t68-28h192q40 0 68 28t28 68v416h416q40 0 68 28t28 68z"/></svg>
                    </div>
                </div>
